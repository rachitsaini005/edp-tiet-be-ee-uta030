...
A few clear bugs were fixed while transcribing the Arduino sketches out of the
original reports — inconsistent function-name capitalization, a missing
closing brace, one stray typo. The logic itself, including a couple of unused
variables and pin numbers referenced but never declared in some snippets, was
